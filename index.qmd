...
4\. **Data visualization with ggplot2**: Using `ggplot2` for creating publication-quality figures.

# Data

We will work with example datasets commonly used in public health, such as synthetic outbreak data and demographic datasets.\
All data will be downloaded directly from within R during the sessions.
